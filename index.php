...
if(isset($_REQUEST["login"])){
    ...
    $qr = $obj->con1->prepare("SELECT * FROM `admin` where username=? and binary(password)=? and status='enable'");
            ...
            <div class="panel m-6 w-full max-w-lg sm:w-[480px]">
                ...
                <form class="space-y-5" method="post">
                    <div>
                        ...
                        <input type="text" name="username" id="username" class="form-input" placeholder="Enter Email" required />
                    </div>
                    <div>
