                            ...
                            data: [
                                ...
                                while ($row = mysqli_fetch_array($Resp)) { ?>
                                    [
                                        ...
                                        // '<img src="images/banner_image/<?php echo addslashes($row["image"]);?>" height="200" width="200" class="object-cover shadow rounded">',
                                        `<?php 
                                        ...
                                        ?>
                                            <img src="images/banner_image/<?php echo addslashes($row["image"]);?>" width="200" height="200" style="display:<?php (in_array($extn, $img_array))?'block':'none' ?>" class="object-cover shadow rounded">
                                        <?php
                                             //} else if (["mp4", "webm", "ogg"].includes(extn)) { 
                                             } if (in_array($extn,$vd_array )) {
                                        ?>
                                            <video src="images/banner_image/<?php echo addslashes($row["image"]);?>" height="200" width="200" style="display:<?php (in_array($extn, $vd_array))?'block':'none' ?>" class="object-cover shadow rounded" controls></video>
                                        <?php } ?>`,
                                        ...
                                        getActions(<?php echo $row["b_id"];?>,'<?php echo addslashes($row["image"]);?>')
                                        ],
                                    <?php $i++;}
                                    ?>
                                    ],
