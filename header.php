            ...
            <nav x-data="sidebar"
                ...
                <div class="h-full bg-white dark:bg-[#0e1726]">
                    ...
                    <ul
                        ...
                        <li class="menu nav-item">
                            <a href="project.php"
                                class="nav-link group <?php echo basename($_SERVER["PHP_SELF"]) == "project.php" ? "active" : "" ?>">
                                <div class="flex items-center">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="w-6 h-6">
                                    ...
                                    <span
                                        class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Project
                                    </span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="menu nav-item">
                            <a href="career.php"
                                class="nav-link group <?php echo basename($_SERVER["PHP_SELF"]) == "career.php" ? "active" : "" ?>">
                                <div class="flex items-center">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="w-6 h-6">
                                        <path opacity="0.5"
                                    ...
                                    <span
                                        class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Career
                                    </span>
                                </div>
                            </a>
                        </li>
                        <li class="menu nav-item">
                            <a href="career_list.php"
                                class="nav-link group <?php echo basename($_SERVER["PHP_SELF"]) == "career_list.php" ? "active" : "" ?>">
                                <div class="flex items-center">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="w-6 h-6">
                                        <path opacity="0.5"
                        ...
                        <li class="menu nav-item">
                            <a href="team_member.php"
                                class="nav-link group <?php echo basename($_SERVER["PHP_SELF"]) == "team_member.php" ? "active" : "" ?>">
                                <div class="flex items-center">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span
                                        class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Team
                                        Member
                                    </span>
                                </div>
                            </a>
